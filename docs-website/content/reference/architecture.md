---
title: "Architecture"
description: "System architecture, request flow, key design decisions, and package responsibilities."
weight: 10
---
...
The browser communicates with the server through two channels:

- **HTTP** — HTMX sends standard HTTP requests and swaps the returned HTML fragments into the DOM.
- **WebSocket** — xterm.js maintains persistent WebSocket connections for terminal I/O and Docker log streaming.
...
The frontend uses HTMX for most UI interactions instead of a JavaScript SPA framework:
